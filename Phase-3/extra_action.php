...
$sec = htmlspecialchars($_GET['extra']);
$sql1 =<<<EOF
...
SELECT *
FROM APPS
WHERE appnod = (SELECT MAX(appnod)
                                FROM APPS,APP_SPECs
                                WHERE app_id=appid_spec AND space_req_in_MB<200);
EOF;
$sql3=<<<EOF
